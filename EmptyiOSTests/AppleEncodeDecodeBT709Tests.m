...
@interface AppleEncodeDecodeBT709Tests : XCTestCase
...
@implementation AppleEncodeDecodeBT709Tests
...
- (void)testBT709Decoder_SMPTE_Gray_0xc0c0c0_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
//  Bin = 224;
  ...
  // C (no gamma) code Linear RGB (192 192 192) -> REC.709 (180 128 128)
...
- (void)testBT709Decoder_SMPTE_Gray_0xc0c0c0_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
  ...
  // Writing with vImage to correct 16-235 range generates Y = 206
...
- (void)testBT709Decoder_SMPTE_Gray_0x808080_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x808080_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x555555_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
  ...
  //
  // sRGB (85 85 85) -> Linear RGB (23 23 23) -> REC.709 (80 128 128)
...
- (void)testBT709Decoder_SMPTE_Gray_0x555555_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x555555_linear_metal {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x3F3F3F_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x191919_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x0D0D0D_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x040404_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x030303_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
  ...
  // Gray 1% linear intensity : 0.0144
  //
  // sRGB (30 30 30) -> Linear RGB (3 3 3) -> REC.709 (47 128 128)
...
- (void)testBT709Decoder_SMPTE_Gray_0x020202_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
  ...
  // Note that this test case features a value that is above the linear cutoff
...
- (void)testBT709Decoder_SMPTE_Gray_0x020202_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
  ...
  //
  // Note that this test case features a value that is below
  // the linear scale by 16 values for the Apple 196 curve.
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_n2_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
  ...
  
  {
    int v = Y;
    //int expectedVal = 18;
    // This input grayscale falls below the 1.961 cutoff and becomes (gray * 16)
    int expectedVal = 21;
    XCTAssert(v == expectedVal, @"%3d != %3d", v, expectedVal);
  }
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_n2_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_n3_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_n3_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_n4_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
  ...
  // Gray LT 1% linear intensity : 0.0144
  //
  // sRGB (1 1 1) -> Linear RGB (1 1 1) -> REC.709 (17 128 128)
  //
...
- (void)testBT709Decoder_SMPTE_Gray_0x010101_n4_linear_vImage {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
...
- (void)testBT709Decoder_SMPTE_Gray_0_linear_software {
  uint32_t Rin, Gin, Bin;
  uint32_t Y, Cb, Cr, dummy;
  uint32_t Rout, Gout, Bout;
